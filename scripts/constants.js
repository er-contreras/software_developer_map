...
export const FORM_WRAPPER_SELECTOR = ".form-wrapper";
export const CLOSE_BUTTON_SELECTOR = ".close-btn";
export const FORM_SUBMIT_BUTTON_SELECTOR = '.form-wrapper form input[type="submit"]';
